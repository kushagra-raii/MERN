const data = [
	...
	},
	{
		id: 2,
		name: "Jaipur",
		info: `Jaipur is the capital city of the Indian stateaaa of Rajasthan, known for its stunning pink-hued buildings and palaces. The city is also known as the "Pink City" due to the color of many of its buildings. Jaipur is famous for its intricate textiles, colorful handicrafts, and delicious cuisine.`,
